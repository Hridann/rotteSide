$(document).ready(function() {
  var titles = ["Hero", "Genius", "Legend", "Idiot", "Shit", "Ape", "Mastermind", "Knight", "King", 
                "Winner", "Clown", "Teacher", "Human", "God", "Messia", "Prophet", "Prisoner", "Survivor", 
                "Predator", "Loser", "Disciple", "Warden", "Trailblazer", "Phantom", "High Commander", "Lord", 
                "Wiener", "Failure", "Millionaire", "Refugee", "Billionaire", "Ninja", "Reaper", "Pirate", "Devil", 
                "Monarch", "Ruler", "Hellspawn", "Demon", "Angel", "Nobody", "Giant", "Fish", "Puppet", "Puppeteer"];
  var cause = ["of Justice", "of Evil", "of Pranks", "of Stupidity", "of Power", "of Death", "of Earth",
               "of the Milkyway", "from Mars", "of Good", "of Memes", "of Joy", "of Sorrow", "from Jupiter", 
               "from Venus", "from the Andromeda galaxy", "among Losers", "from nowhere", "of Immortality", 
               "King", "of Eden", "from Hell", "from Heaven"];
